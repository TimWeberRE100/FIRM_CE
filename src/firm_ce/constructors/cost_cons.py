...
def construct_UnitCost_object(
    ...
    fuel_cost (float): The cost of fuel consumed by the generator [$/GJ]. For assets that are not
        Generators, value is 0.0.
    ...
    fuel_cost_mwh = fuel_cost * heat_rate_incr
    fuel_cost_h = fuel_cost * heat_rate_base
