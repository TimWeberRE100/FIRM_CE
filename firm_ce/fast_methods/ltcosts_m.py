...
@njit(fastmath=FASTMATH)
def calculate_annualised_build(ltcosts_instance: LTCosts_InstanceType,
...
@njit(fastmath=FASTMATH)
def calculate_fom(ltcosts_instance: LTCosts_InstanceType, 
                    power_capacity: float64, 
                    years_float: float64,
                    line_length: float64,
                    unit_costs: UnitCost_InstanceType,
...
@njit(fastmath=FASTMATH)
def calculate_vom(ltcosts_instance: LTCosts_InstanceType, 
                    generation: float64, 
...
@njit(fastmath=FASTMATH)
def calculate_fuel(ltcosts_instance: LTCosts_InstanceType,
                    generation: float64, 
                    unit_hours: float64, 
                    unit_costs: UnitCost_InstanceType) -> None:
